...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border/50 bg-transparent hover:bg-accent/50 hover:border-border/70 shadow-sm hover:shadow-sm',
        secondary:
        ...
        <Slot
          className={cn(
            ...
            'active:scale-[0.98] active:opacity-90 transition-transform',
            {
              ...
              'shadow-inner': variant === 'ghost' || variant === 'link',
            },
            className
          )}
          ref={ref}
